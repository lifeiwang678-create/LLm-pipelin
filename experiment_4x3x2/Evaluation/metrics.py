...
def summarize_and_save(
    ...
    metrics = {
        ...
        "predicted_label_distribution": _series_distribution(df.get("y_pred")),
        "valid_true_label_distribution": _series_distribution(valid_df.get("y_true")),
        "valid_predicted_label_distribution": _series_distribution(valid_df.get("y_pred")),
